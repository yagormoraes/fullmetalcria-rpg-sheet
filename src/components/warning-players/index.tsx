export default function WarningPlayers() {
    return (
        <div className="flex flex-col bg-orange-400 p-2 m-5 rounded-lg">
            <span className="text-2xl font-bold">Atenção Jogadores e Mestres!</span>
            <span className="font-bold">Para jogar com as regras completas, é preciso ter o livro do jogo.</span>
            ...
            <span>Full Metal Cria é um sistema brasileiro de RPG produzido pela <a className="font-bold" href="https://indievisivelpress.com.br">Indievisivel Press.</a></span>
        </div>
    )
}